...
The modified Yggdrasil now supports IP forwarding, allowing you to forward arbitrary IPv4 or IPv6 traffic through the mesh without needing additional tunnels.
